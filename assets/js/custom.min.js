  ...
  e(window).load(function () {
    ...
    e(document).ready(function () {
      function t() {
        e(window).scrollTop() > 10
          ? (n.addClass("header-small"),
            e(".header-fixed").removeClass("header-transparent"))
          : (n.removeClass("header-small"),
            e(".header-fixed").addClass("header-transparent"));
      }
      ...
      function a() {
        ...
        var o = e.offsetWidth;
        return (
          a == o && (o = t.clientWidth), document.body.removeChild(t), a - o
        );
      }
      ...
      (i =
        ...
        e(".js-stick").stick_in_parent(),
        e(".nav-icon-toggle").on("click", function () {
        ...
        e(document).on("click", ".main-nav.in", function (t) {
          e(t.target).is("a") &&
            !e(t.target).parent().hasClass("has-submenu") &&
            (e(this).collapse("hide"),
            e(".nav-icon-toggle").toggleClass("open"));
        }),
        e(".flexslider").flexslider({
          ...
          before: function (t) {
            e(".hero-caption").fadeOut().animate(
              ...
              t.slides.eq(t.currentSlide).delay(500),
              t.slides.eq(t.animatingTo).delay(500);
          },
          after: function (t) {
      ...
      var s = e(
        ".module-hero, .module, .module-sm, .module-xs, .background-side, .footer"
      );
      s.each(function () {
        ...
        e(document).on("click", function (t) {
          ...
          a.is(t.target) ||
            ...
            e("body").removeClass("off-canvas-cart-open");
        }),
        e(".off-canvas-cart-wrapper").css("margin-right", "-" + a() + "px"),
        e("#modal-search, .form-close-btn").on("click", function () {
      ...
      var l = e("#filters"),
        c = e("#works-grid"),
        d = "masonry";
      (d = c.hasClass("works-grid-masonry") ? "masonry" : "fitRows"),
        e("a", l)
          .on("click", function () {
            var t = e(this).attr("data-filter");
            return (
              e(".current", l).removeClass("current"),
      ...
      if (u.length > 0) {
        var h,
          m = u[0].getAttribute("data-addresses").match(g),
              ...
              events: {
                click: function (t, a, o) {
                  if (o.data) {
                    ...
                    n
                      ? (n.open(i, t), n.setContent(o.data))
                      : e(this).gmap3({
                          infowindow: {
                            anchor: t,
                            options: {
      ...
      window.addEventListener(
        ...
        function () {
          clearTimeout(x),
            C.classList.contains("disable-hover") ||
              C.classList.add("disable-hover"),
