...
!(function (t) {
      ...
      var o = t(window),
        a = function () {
          ...
          var t = o.scrollLeft(),
            ...
            p = n.width(),
            f = o.width();
          s + c + u >= e && e + d + u >= s && r + p + l >= t && t + f + l >= r
    ...
    (t.fn.countTo = function (e) {
      ...
      return t(this).each(function () {
        function o() {
          (s += i),
            r++,
            t(a).html(s.toFixed(e.decimals)),
            "function" == typeof e.onUpdate && e.onUpdate.call(a, s),
            r >= n &&
              (clearInterval(l),
              (s = e.to),
              "function" == typeof e.onComplete && e.onComplete.call(a, s));
        }
        var a = this,
          r = 0,
          s = e.from,
  ...
  (function (t, e) {
    ...
    function g(t, e, n) {
      ...
      return !t || i(t)
        ...
        ? t
        : m(t.lat)
        ? new W.LatLng(t.lat, t.lng)
        : !n && q(t) && m(t[0]) && m(t[1])
        ? new W.LatLng(t[0], t[1])
        : o;
    }

    function y(t) {
      var e, n;
      return !t || t instanceof W.LatLngBounds
        ? t || null
        : (q(t)
            ? 2 === t.length
              ? ((e = g(t[0])), (n = g(t[1])))
          ...
          e && n ? new W.LatLngBounds(n, e) : null);
    }
        ...
        ? ((a = a || 0),
          l
            ...
            : (s.location && (s.location = g(s.location)),
              ...
              C().geocode(s, function (i, r) {
                r === W.GeocoderStatus.OK
                  ? (F.store(s, {
                      results: i,
                      status: r,
                    }),
                    ...
                    (o.status = r),
                    e.apply(t, [o]))
                  : r === W.GeocoderStatus.OVER_QUERY_LIMIT &&
                    a < D.queryLimit.attempt
                  ? setTimeout(function () {
                      w.apply(u, [t, e, n, o, a + 1]);
                    }, D.queryLimit.delay +
                      Math.floor(Math.random() * D.queryLimit.random))
      ...
      (this.get = function (e) {
        if (t.length) {
          ...
          for (i = 0; i < t.length; i++) {
            for (
              r = t[i], s = l.length === r.keys.length, o = 0;
              o < l.length && s;
              o++
            )
              (a = l[o]),
                ...
                s &&
                  (s =
                    n(e[a]) && "equals" in e[a] && B(e[a])
                      ? e[a].equals(r.request[a])
                      : e[a] === r.request[a]);
        ...
        (r.rm = function (t, e, n) {
          ...
          if (e)
            if (n)
              for (
                a = i[t].length - 1;
                a >= 0 && ((s = i[t][a]), !e(o[s].tag));
                a--
              );
            else
              for (
                a = 0;
                a < i[t].length && ((s = i[t][a]), !e(o[s].tag));
                a++
              );
    ...
    function z(e, i, o) {
      function a(t) {
        z[t] ||
          (delete O[t].options.map,
          (z[t] = new D.classes.Marker(O[t].options)),
          u(
            e,
            {
              td: O[t],
      ...
      function r() {
        return (y = j.getProjection())
          ? ((T = !0),
            E.push(W.event.addListener(i, "zoom_changed", f)),
            E.push(W.event.addListener(i, "bounds_changed", f)),
            void h())
      ...
      function l(t) {
        n(M[t])
          ? (B(M[t].obj.setMap) && M[t].obj.setMap(null),
            B(M[t].obj.remove) && M[t].obj.remove(),
            B(M[t].shadow.remove) && M[t].obj.remove(),
            B(M[t].shadow.setMap) && M[t].shadow.setMap(null),
            delete M[t].obj,
            delete M[t].shadow)
          : z[t] && z[t].setMap(null),
          delete M[t];
      ...
      function c() {
        var t,
          ...
          c = arguments;
        return (
          c[0] instanceof W.LatLng
            ? ((t = c[0].lat()),
              (n = c[0].lng()),
              c[1] instanceof W.LatLng
                ? ((e = c[1].lat()), (i = c[1].lng()))
                : ((e = c[1]), (i = c[2])))
            : ((t = c[0]),
              (n = c[1]),
              c[2] instanceof W.LatLng
                ? ((e = c[2].lat()), (i = c[2].lng()))
                : ((e = c[2]), (i = c[3]))),
          (o = (Math.PI * t) / 180),
          (a = (Math.PI * n) / 180),
      ...
      function m(t) {
        var e = y.fromLatLngToDivPixel(t),
          n = y.fromDivPixelToLatLng(
            new W.Point(e.x + o.radius, e.y - o.radius)
          ),
      ...
      function h() {
        if (!I && !S && T) {
          ...
          for (
            ...
            !O[e] ||
              (y && !s.contains(O[e].options.position)) ||
              (w && !w(N[e])) ||
              x.push(e);
          for (;;) {
              ...
              do
                for (
                  f = r,
                    r = [],
                    g--,
                    c = f.length ? s.getCenter() : O[x[e]].options.position,
                    s = m(c),
                    n = e;
                  n < x.length;
                  n++
                )
                  L[n] || (s.contains(O[x[n]].options.position) && r.push(n));
              while (f.length < r.length && r.length > 1 && g);
            } else
            ...
            for (
              ...
              (L[r[a]] = !0),
                u.indexes.push(x[r[a]]),
                u.ref.push(x[r[a]]),
                (h += O[x[r[a]]].options.position.lat()),
                (v += O[x[r[a]]].options.position.lng());
            (h /= r.length),
              (v /= r.length),
              (u.latLng = new W.LatLng(h, v)),
              (u.ref = u.ref.join("-")),
              u.ref in _
                ? delete _[u.ref]
                : (1 === r.length && (M[u.ref] = !0), b(u));
          }
          t.each(_, function (t) {
            l(t);
          }),
      ...
      r(),
        ...
        (L.clear = function (t, e, n) {
          ...
          for (
            t
              ? ((i = O.length - 1), (o = -1), (a = -1))
              : ((i = 0), (o = O.length), (a = 1)),
              r = i;
            r !== o &&
            (!O[r] || (u && !u(O[r].tag)) || (l.push(_[r]), !e && !t));
            r += a
          );
        ...
        (L.autofit = function (t) {
          ...
          for (e = 0; e < O.length; e++)
            O[e] && t.extend(O[e].options.position);
        });
    }
        ...
        (a.onAdd = function () {
          ...
          n.pane in e && t(e[n.pane]).append(o),
            t.each(
              ...
              function (e, n) {
                r.push(
                  W.event.addDomListener(o[0], n, function (e) {
                    t.Event(e).stopPropagation(),
                      W.event.trigger(a, n, [e]),
                      a.draw();
                  })
                );
              }
            ...
            r.push(
              W.event.addDomListener(o[0], "contextmenu", function (e) {
                t.Event(e).stopPropagation(),
                  W.event.trigger(a, "rightclick", [e]),
                  a.draw();
              })
            );
        }),
    ...
    function j(o) {
      ...
      function d(t) {
        ...
        n &&
          ...
          B(n) ? n.apply(o, e) : q(n) && B(n[1]) && n[1].apply(n[0], e));
      }
      ...
      function v(e, n) {
        ...
        A
          ? i && (i.center && (i.center = g(i.center)), A.setOptions(i))
          : ((i = n.opts || t.extend(!0, {}, D.map, i || {})),
            (i.center = e || g(i.center)),
            (A = new D.classes.Map(o.get(0), i)));
      }
                ...
                if (f.options[i])
                  if (f.options[i][0][0] && q(f.options[i][0][0]))
                    for (l = 0; l < f.options[i].length; l++)
                      for (c = 0; c < f.options[i][l].length; c++)
                        f.options[i][l][c] = g(f.options[i][l][c]);
                  else
                    for (l = 0; l < f.options[i].length; l++)
                      f.options[i][l] = g(f.options[i][l]);
                (f.options.map = A),
                  (d = new W[n](f.options)),
                  a.push(d),
                  (s = S.add(
      ...
      (I._plan = function (t) {
        ...
        (I.overlay = function (e, n) {
          ...
          return (
            ...
            e.td.values.length
              ? (N.__initialised ||
                  ((N.prototype = new D.classes.OverlayView()),
                  (N.__initialised = !0)),
                t.each(e.td.values, function (a, r) {
                  var s,
                    l,
                    c = p(e, r),
        ...
        (I.marker = function (e) {
          ...
          return (
            ...
            e.td.values.length
              ? (l && v(),
                e.td.cluster && !A.getBounds()
                  ? void W.event.addListenerOnce(
                      A,
                      "bounds_changed",
                      function () {
                        I.marker.apply(I, [e]);
                  ...
                  : void (e.td.cluster
                      ? (e.td.cluster instanceof O
                          ? ((i = e.td.cluster), (a = S.getById(i.id(), !0)))
                          : ((a = w(e.td.cluster)),
                            (i = new O(s(e.td.id, !0), a)),
                            S.add(e, "clusterer", i, a)),
                        a.beginUpdate(),
                        t.each(e.td.values, function (t, n) {
                          ...
                          (i.options.position = g(
                            ...
                            i.options.position &&
                              ((i.options.map = A),
                              l && (A.setCenter(i.options.position), (l = !1)),
                              a.add(i, n));
                        }),
                        a.endUpdate(),
                        m(e, i))
                      : ((n = []),
                        t.each(e.td.values, function (t, i) {
                          ...
                          (s.options.position = g(
                            s.options.position ? s.options.position : i
                          )),
                            s.options.position &&
                              ((s.options.map = A),
                              l && (A.setCenter(s.options.position), (l = !1)),
                              (r = new D.classes.Marker(s.options)),
                              n.push(r),
                              (a = S.add(
                                {
                                  td: s,
        ...
        (I.getdistance = function (t) {
          var e;
          for (
            t.opts.origins = h(t.opts.origins), e = 0;
            e < t.opts.origins.length;
            e++
          )
            t.opts.origins[e] = g(t.opts.origins[e], !0);
          for (
            t.opts.destinations = h(t.opts.destinations), e = 0;
            ...
            e.td.values.length
              ? (t.each(e.td.values, function (t, i) {
                  var a,
                    ...
                    s = p(e, i);
                  (s.options.center = g(
                    s.options.center ? s.options.center : i
                  )),
                    A || v(s.options.center),
                    (s.options.map = A),
                    (r = new D.classes.Circle(s.options)),
                    n.push(r),
                    (a = S.add(
                      {
                        td: s,
        ...
        (I.getmaxzoom = function (t) {
          P().getMaxZoomAtLatLng(t.latLng, function (e) {
            d(t, e.status === W.MaxZoomStatus.OK ? e.zoom : !1, status),
              x.ack();
          });
        }),
        (I.getelevation = function (t) {
          ...
          if (t.latLng) n.push(t.latLng);
            ...
            for (n = h(t.td.locations || []), e = 0; e < n.length; e++)
              n[e] = g(n[e]);
          if (n.length)
            _().getElevationForLocations(
              {
                locations: n,
              },
              i
            ...
            e.td.values.length
              ? (t.each(e.td.values, function (t, i) {
                  var a,
                    ...
                    s = p(e, i);
                  (s.options.bounds = y(
                    s.options.bounds ? s.options.bounds : i
                  )),
                    A || v(s.options.bounds.getCenter()),
                    (s.options.map = A),
                    (r = new D.classes.Rectangle(s.options)),
                    n.push(r),
                    (a = S.add(
                      {
                        td: s,
        ...
        (I.bicyclinglayer = function (t) {
          ...
          e ||
            ((e = new D.classes.BicyclingLayer()),
            e.setMap(A),
        ...
        (I.streetviewpanorama = function (e) {
          ...
          var n,
            i = new D.classes.StreetViewPanorama(e.opts.container, e.opts.opts);
          i && A.setStreetView(i),
            (n = S.add(e, "streetviewpanorama", i)),
            m(e, i, n);
        }),
            ...
            e.td.values.length
              ? (t.each(e.td.values, function (t, i) {
                  ...
                  A || v(),
                    ...
                    c.options.opts &&
                      ((s = c.options.opts),
                      c.options.url && (s.url = c.options.url)),
                    (s.map = A),
                    (r = l("3.10")
                      ? new D.classes.KmlLayer(s)
                      : new D.classes.KmlLayer(s.url, s)),
                    n.push(r),
                    (a = S.add(
                      {
                        td: c,
        ...
        (I.panel = function (e) {
          ...
          l.css({
            ...
            e.opts.content &&
              ...
              a(e.opts.left)
                ? a(e.opts.right)
                  ? e.opts.center && (r = (o.width() - i.width()) / 2)
                  : (r = o.width() - i.width() - e.opts.right)
                : (r = e.opts.left),
              a(e.opts.top)
                ? a(e.opts.bottom)
                  ? e.opts.middle && (s = (o.height() - i.height()) / 2)
                  : (s = o.height() - i.height() - e.opts.bottom)
                : (s = e.opts.top),
              l.css({
                top: s,
                left: r,
        ...
        (I.autofit = function (e) {
          ...
          t.each(S.all(), function (t, e) {
            e.getPosition
              ...
              : "function" == typeof O &&
                e instanceof O &&
                ((e = S.getById(e.id(), !0)), e && e.autofit(n));
          }),
            n.isEmpty() ||
              (A.getBounds() && A.getBounds().equals(n)) ||
              ("maxZoom" in e.td &&
                W.event.addListenerOnce(A, "bounds_changed", function () {
        ...
        (I.clear = function (e) {
          ...
          e.td.id
            ...
            : (S.clear(h(e.td.name), e.td.last, e.td.first, e.td.tag),
              S.objClear(h(e.td.name), e.td.last, e.td.first, e.td.tag)),
            m(e, !0);
        }),
        (I.get = function (n, o, a) {
          ...
          return (
            o || (a = l.full),
            i(l)
              ? ((s = S.getById(l, !1, a) || S.objGetById(l)),
                s === !1 && ((r = l), (l = {})))
              : (r = l.name),
            "map" === r && (s = A),
            s ||
              ...
              l.id
                ? (t.each(h(l.id), function (t, e) {
                  ...
                  q(l.id) || (s = s[0]))
                : (t.each(r ? h(r) : [e], function (e, n) {
                    var i;
                    l.first
                      ? ((i = S.get(n, !1, l.tag, a)), i && s.push(i))
                      : l.all
                      ? t.each(S.all(n, l.tag, a), function (t, e) {
                          s.push(e);
                        })
        ...
        (I.exec = function (e) {
          t.each(h(e.td.func), function (n, i) {
            t.each(
              I.get(e.td, !0, e.td.hasOwnProperty("full") ? e.td.full : !0),
              function (t, e) {
                i.call(o, e);
              }
            );
    ...
    t.fn.gmap3 = function () {
      var e,
        ...
        i = !0,
        o = [];
      for (r(), e = 0; e < arguments.length; e++)
      ...
      return (
        ...
        t.each(this, function () {
          var e = t(this),
            a = e.data("gmap3");
          (i = !1),
            a || ((a = new j(e)), e.data("gmap3", a)),
            1 !== n.length || ("get" !== n[0] && !I(n[0]))
              ? a._plan(n)
              : "get" === n[0]
              ? o.push(a.get("map", !0))
              : o.push(a.get(n[0].get, !0, n[0].get.full));
        }),
      ...
      (i.emitEvent = function (t, e) {
        ...
        for (i in a)
          if (a.hasOwnProperty(i))
            for (n = a[i].length; n--; )
              (o = e ? a[i][n].apply(null, e) : a[i][n]()),
                o === !0 && this.removeListener(t, a[i][n]);
        return this;
      }),
  ...
  (function (t) {
    ...
    function o(t, n) {
      function o(t, n, r) {
        ...
        "string" == typeof t && (t = document.querySelectorAll(t)),
          ...
          "function" == typeof n ? (r = n) : e(this.options, n),
          r && this.on("always", r),
          this.getImages(),
      ...
      (o.prototype = new t()),
        ...
        (o.prototype.getImages = function () {
          ...
          for (var t = 0, e = this.elements.length; e > t; t++) {
            ...
            for (
              var i = n.querySelectorAll("img"), o = 0, a = i.length;
              a > o;
              o++
            ) {
              var r = i[o];
        ...
        (o.prototype.check = function () {
          function t(t, o) {
            return (
              e.options.debug && s && r.log("confirm", t, o),
              e.progress(t),
              n++,
              n === i && e.complete(),
              !0
    ...
    "function" == typeof define && define.amd
      ? define(["eventEmitter", "eventie"], o)
      : (t.imagesLoaded = o(t.EventEmitter, t.eventie));
  })(window),
  /*!
    ...
    function o(o) {
      return (
        "complete" === a.readyState
          ? i()
          : (o.bind(a, "DOMContentLoaded", n),
            o.bind(a, "readystatechange", n),
            o.bind(t, "load", n)),
        e
      );
    }
  ...
  (function (t, e) {
    ...
    function a(e) {
      ...
      function a(t) {
        if (
          ...
          for (
            var r = (a.isBorderBox = !(!c || !e[c] || "border-box" !== e[c])),
              p = 0,
              f = s.length;
            f > p;
            p++
    ...
    "function" == typeof define && define.amd
      ...
      : "object" == typeof exports
      ? (module.exports = a(require("desandro-get-style-property")))
      : (t.getSize = a(t.getStyleProperty));
  })(window),
  /**
  ...
  (function (t) {
    ...
    function i(t, e) {
      n(t);
      for (
        var i = t.parentNode.querySelectorAll(e), o = 0, a = i.length;
        a > o;
        o++
      )
        if (i[o] === t) return !0;
    ...
    function o(t, o, a) {
      ...
      e(s.prototype, t.prototype),
        ...
        (s.prototype.getPosition = function () {
          ...
          (o -= n ? s.paddingLeft : s.paddingRight),
    ...
    function r(n, r, d, f, m, h) {
      ...
      return (
        ...
        (v.prototype._filterFindItemElements = function (t) {
          t = i(t);
          for (
            var e = this.options.itemSelector, n = [], o = 0, a = t.length;
            a > o;
            o++
          ) {
            var r = t[o];
            if (p(r))
              if (e) {
                m(r, e) && n.push(r);
                for (
                  var s = r.querySelectorAll(e), l = 0, u = s.length;
                  u > l;
                  l++
                )
                  n.push(s[l]);
        ...
        (v.prototype._getContainerSize = c),
        ...
        (v.prototype._itemsOn = function (t, e, n) {
          ...
          for (
            var o = 0, a = t.length, r = this, s = 0, l = t.length;
            l > s;
            s++
          ) {
            var u = t[s];
        ...
        (v.create = function (t, n) {
          ...
          return (
            Object.create
              ...
              : e(i.prototype, v.prototype),
            (i.prototype.constructor = i),
            (i.defaults = e({}, v.defaults)),
            e(i.defaults, n),
            ...
            (i.Item.prototype = new h()),
            r(function () {
              for (
                var e = a(t),
                  n = s.querySelectorAll(".js-" + e),
                  o = "data-" + e + "-options",
                  r = 0,
                  c = n.length;
                c > r;
        ...
        (p.prototype._filter = function (t) {
          ...
          for (
            ...
            if (!u.isIgnored) {
              var c = r(u);
              c && i.push(u),
                c && u.isHidden ? o.push(u) : c || u.isHidden || a.push(u);
            }
          }
          var d = this;
    ...
    var i = [],
              ...
              t(l).bind("submit", function (e) {
                ...
                a
                  ...
                  a.each(function (e, n) {
                    ...
                    a.hasClass("warning") &&
                      (a.removeClass("warning").addClass("error"), o++);
                  }),
                  a.trigger("validationLostFocus.validation"),
                  o
                    ? (n.options.preventSubmit && e.preventDefault(),
                      i.addClass("error"),
                      t.isFunction(n.options.submitError) &&
                        n.options.submitError(
                          i,
                          e,
                          a.jqBootstrapValidation("collectErrors", !0)
                        ))
                    : (i.removeClass("error"),
                      t.isFunction(n.options.submitSuccess) &&
                        n.options.submitSuccess(i, e));
              }),
              this.each(function () {
                var e = t(this),
                ...
                if (
                  (!s.length &&
                    n.options.autoAdd &&
                    n.options.autoAdd.helpBlocks &&
                    ((s = t('<div class="help-block" />')),
                    o.find(".controls").append(s),
                    i.push(s[0])),
                  n.options.sniffHtml)
                ) {
                  var c = "";
                  ...
                  void 0 !== e.attr("maxlength") &&
                    ...
                    (void 0 === e.attr("required") &&
                      ...
                      ((c = n.builtInValidators.required.message),
                    ...
                    void 0 !== e.attr("type") &&
                      ...
                      ((c = n.builtInValidators.number.message),
                ...
                do
                  t.each(u, function (t, e) {
                    ...
                    t.each(f, function (i, o) {
                      if (void 0 !== e.data("validation" + o + "Shortcut"))
                        t.each(
                          e.data("validation" + o + "Shortcut").split(","),
                          function (t, e) {
                            m.push(e);
                          }
                        );
                ...
                t.each(u, function (i, o) {
                  ...
                  if (
                    ...
                    t.each(n.validatorTypes, function (n, i) {
                      void 0 === h[n] && (h[n] = []),
                        l ||
                          void 0 === e.data("validation" + o + a(i.name)) ||
                          (h[n].push(
                            t.extend(
                              !0,
                              {
                    ...
                    var u = t.extend(
                      !0,
                      {},
                      n.builtInValidators[o.toLowerCase()]
                    );
                    s && (u.message = r);
                      ...
                      : t.each(n.validatorTypes, function (n, i) {
                          void 0 === h[n] && (h[n] = []),
                            l ||
                              c !== n.toLowerCase() ||
                              (e.data(
                                "validation" + o + a(i.name),
                                u[i.name.toLowerCase()]
                              ),
                              h[c].push(t.extend(u, i.init(e, o))),
                              (l = !0));
                        });
                  }
                  ...
                  e.bind("validation.validation", function (i, o) {
                    var a = r(e),
                      s = [];
                    return (
                      t.each(h, function (i, r) {
                        (a ||
                          a.length ||
                          (o && o.includeEmpty) ||
                          (n.validatorTypes[i].blockSubmit &&
                            o &&
                            o.submitting)) &&
                          t.each(r, function (t, o) {
                            n.validatorTypes[i].validate(e, a, o) &&
                              s.push(o.message);
                          });
                      }),
                      s
                  ...
                  e.bind(
                    ...
                    function (i, a) {
                      ...
                      o.find("input,textarea,select").each(function (n, i) {
                        ...
                        if (
                          (t.each(
                            t(i).triggerHandler("validation.validation", a),
                            function (t, e) {
                              c.push(e);
                            }
                          ),
                        ...
                        c.length
                          ? (o.removeClass("success error").addClass("warning"),
                            n.options.semanticallyStrict && 1 === c.length
                              ? s.html(
                                  c[0] +
                                    (n.options.prependExistingHelpBlock
                                      ? s.data("original-contents")
                                      : "")
                                )
                              : s.html(
                          ...
                          : (o.removeClass("warning error success"),
                            u.length > 0 && o.addClass("success"),
                            s.html(s.data("original-contents"))),
                        "blur" === i.type && o.removeClass("success");
                    }
                  ),
          ...
          destroy: function () {
            return this.each(function () {
              ...
              e.unbind(".validation"),
                ...
                o.attr("role", e.data("original-role")),
                i.indexOf(o[0]) > -1 && o.remove();
            });
          },
          ...
          hasErrors: function () {
            ...
            return (
              this.each(function (n, i) {
                e = e.concat(
                  t(i).triggerHandler("getValidators.validation")
                    ? t(i).triggerHandler("validation.validation", {
                        submitting: !0,
                      })
                    : []
                );
        ...
        validatorTypes: {
          ...
          ajax: {
            ...
            validate: function (e, n, i) {
              return "" + i.lastValue == "" + n && i.lastFinished === !0
                ? i.lastValid === !1
                : (i.lastFinished === !0 &&
                    ((i.lastValue = n),
                    (i.lastValid = !0),
          ...
          required: {
            ...
            validate: function (t, e, n) {
              return (
                !(0 !== e.length || n.negative) ||
                !!(e.length > 0 && n.negative)
              );
            },
            blockSubmit: !0,
          },
          ...
          max: {
            ...
            validate: function (t, e, n) {
              return (
                (parseFloat(e, 10) > parseFloat(n.max, 10) && !n.negative) ||
                (parseFloat(e, 10) <= parseFloat(n.max, 10) && n.negative)
              );
            },
          },
          min: {
            ...
            validate: function (t, e, n) {
              return (
                (parseFloat(e) < parseFloat(n.min) && !n.negative) ||
                (parseFloat(e) >= parseFloat(n.min) && n.negative)
              );
            },
          },
          maxlength: {
            ...
            validate: function (t, e, n) {
              return (
                (e.length > n.maxlength && !n.negative) ||
                (e.length <= n.maxlength && n.negative)
              );
            },
          },
          minlength: {
            ...
            validate: function (t, e, n) {
              return (
                (e.length < n.minlength && !n.negative) ||
                (e.length >= n.minlength && n.negative)
              );
            },
          },
          maxchecked: {
            ...
            init: function (t, e) {
              ...
              return (
                n.bind("click.validation", function () {
                  t.trigger("change.validation", {
                    includeEmpty: !0,
                  });
                }),
            ...
            validate: function (t, e, n) {
              return (
                (n.elements.filter(":checked").length > n.maxchecked &&
                  !n.negative) ||
                (n.elements.filter(":checked").length <= n.maxchecked &&
                  n.negative)
              );
          ...
          minchecked: {
            ...
            validate: function (t, e, n) {
              return (
                (n.elements.filter(":checked").length < n.minchecked &&
                  !n.negative) ||
                (n.elements.filter(":checked").length >= n.minchecked &&
                  n.negative)
              );
      ...
      r = function (e) {
        var n = e.val(),
          i = e.attr("type");
        return (
          "checkbox" === i && (n = e.is(":checked") ? n : ""),
          "radio" === i &&
            (n =
              t('input[name="' + e.attr("name") + '"]:checked').length > 0
                ? n
                : ""),
          n
        );
  ...
  (function (t) {
    ...
    var n = function (e, i) {
      (this.$element = t(e)),
        (this.options = t.extend({}, n.DEFAULTS, this.dataOptions(), i)),
        this.init();
    };
    (n.DEFAULTS = {
      from: 0,
      ...
      (t.fn.countTo = function (e) {
        return this.each(function () {
          ...
          a && (o && o.stop(), i.data("countTo", (o = new n(this, r)))),
            o[s].call(o);
        });
      });
  }),
    ...
    var e,
      ...
      C = function (e, n, i, o) {
        ...
        return (
          (a.className = "mfp-" + e),
          i && (a.innerHTML = i),
          o ? n && n.appendChild(a) : ((a = t(a)), n && a.appendTo(n)),
          a
        );
      },
      S = function (n, i) {
      ...
      k = function () {
        t.magnificPopup.instance ||
          ((e = new w()), e.init(), (t.magnificPopup.instance = e));
      },
      L = function () {
    ...
    (w.prototype = {
      ...
      open: function (n) {
        ...
        (e.types = []),
          ...
          e.bgOverlay ||
            ((e.bgOverlay = C("bg").on("click" + h, function () {
              e.close();
            })),
            (e.wrap = C("wrap")
              .attr("tabindex", -1)
      ...
      updateItemHTML: function () {
        ...
        if (
          ...
          S("FirstMarkupParse", a),
            a ? (e.currTemplate[i] = t(a)) : (e.currTemplate[i] = !0);
        }
        o && o !== n.type && e.container.removeClass("mfp-" + o + "-holder");
        var r = e["get" + i.charAt(0).toUpperCase() + i.slice(1)](
          n,
          e.currTemplate[i]
        );
        e.appendContent(r, i),
              ...
              if (a.length > 0) {
                ...
                "replaceWith" === r
                  ...
                  ? a.is("img")
                    ? a.attr("src", i)
                    : a.replaceWith(
                        t("<img>").attr("src", i).attr("class", a.attr("class"))
                      )
                  : a.attr(o[1], i);
              }
        ...
        getInline: function (n, i) {
          if ((A(), n.src)) {
            ...
            if (a.length) {
              ...
              r &&
                r.tagName &&
                (M || ((E = o.hiddenClass), (M = C(E)), (E = "mfp-" + E)),
                (P = a.after(M).detach().removeClass(E))),
            ...
            n && n.enabled
              ? ((a += " mfp-gallery"),
                ...
                I("UpdateStatus" + o, function (t, n) {
                  n.text &&
                    (n.text = V(n.text, e.currItem.index, e.items.length));
                }),
          ...
          .appendTo(e),
        {
          init: function () {
            (r = p.outerWidth()),
              ...
              n === p[0]
                ? ((l = r), (s = a))
                : ((l = m.outerWidth()), (s = m.outerHeight())),
              (u = (i.width - r) / l),
              (c = (i.height - a) / s),
              (d = m.offset());
          },
            ...
            (u.onload = function () {
                ...
                i.init(),
                  ...
                  c
                    ...
                    .fadeTo(
                      ...
                      1,
                      t.isFunction(o.onZoomIn) ? o.onZoomIn.call(u) : !1
                    );
              }
              ...
              function n() {
                c.stop().fadeTo(
                  o.duration,
                  0,
                  t.isFunction(o.onZoomOut) ? o.onZoomOut.call(u) : !1
                );
              }
              var i = t.zoom(a, r, u, o.magnify);
              "grab" === o.on
                ? s.on("mousedown.zoom", function (o) {
                    1 === o.which &&
                      (t(document).one("mouseup.zoom", function () {
                        n(), t(document).off(d, i.move);
                      }),
                      e(o),
                      t(document).on(d, i.move),
                      o.preventDefault());
                  })
                : "click" === o.on
                ? s.on("click.zoom", function (o) {
                    return p
                      ? void 0
                      : ((p = !0),
                        e(o),
          ...
          init: function () {
            (o.animating = !1),
                ...
                (function () {
                  ...
                  for (var n in e)
                    if (void 0 !== t.style[e[n]])
                      return (
                        (o.pfx = e[n].replace("Perspective", "").toLowerCase()),
              ...
              o.vars.slideshow &&
                ...
                (o.vars.pauseInvisible && v.pauseInvisible.isHidden()) ||
                  (o.vars.initDelay > 0
              ...
              (o.asNav = !0),
                ...
                s
                  ...
                  : o.slides.on(u, function (e) {
                      ...
                      0 >= a && n.hasClass(r + "active-slide")
                        ? o.flexAnimate(o.getTarget("prev"), !0)
                        : t(o.vars.asNavFor).data("flexslider").animating ||
                          n.hasClass(r + "active-slide") ||
                          ((o.direction = o.currentItem < i ? "next" : "prev"),
                          o.flexAnimate(i, o.vars.pauseOnAction, !1, !0, !0));
                    });
            },
          },
              ...
              if (
                ...
                for (var s = 0; s < o.pagingCount; s++) {
                  if (
                    ...
                    (altText =
                      "" !== n.attr("data-thumb-alt")
                        ? (altText = ' alt="' + n.attr("data-thumb-alt") + '"')
                        : ""),
                    (e =
                      "thumbnails" === o.vars.controlNav
                        ? '<img src="' +
                    ...
                    : void (
                        ...
                        !m &&
                          ...
                          (e.vars.animationLoop ||
                            (c =
                              I /
                              ((0 === e.currentSlide && 0 > I) ||
                              (e.currentSlide === e.last && I > 0)
                                ? Math.abs(I) / u + 2
                                : 1)),
                          e.setProps(l + c, "setTouch")))
                      )
                );
              }
            }
            ...
            function i(t) {
              ...
              if (e) {
                if (e.animatingTo === e.currentSlide && !w && null !== c) {
                  ...
                  e.canAdvance(i) &&
                  ((Number(new Date()) - h < 550 && Math.abs(n) > 50) ||
                    Math.abs(n) > u / 2)
              ...
              : ((v = function (t) {
                ...
                (g = function (t) {
                  (b = t.touches[0].pageX),
                    ...
                    (c = d ? a - x : a - b),
                    (w = d
                      ? Math.abs(c) < Math.abs(b - r)
                      : Math.abs(c) < Math.abs(x - r));
                  var e = 500;
                  (!w || Number(new Date()) - h > e) &&
                    (t.preventDefault(),
                    !m &&
                      o.transitions &&
                      (o.vars.animationLoop ||
                        (c /=
                          (0 === o.currentSlide && 0 > c) ||
                          (o.currentSlide === o.last && c > 0)
                            ? Math.abs(c) / u + 2
                            : 1),
                      o.setProps(l + c, "setTouch")));
                }),
                (y = function (t) {
                  if (
                    (n.removeEventListener("touchmove", g, !1),
                    o.animatingTo === o.currentSlide && !w && null !== c)
                  ) {
                    var e = p ? -c : c,
                      i = e > 0 ? o.getTarget("next") : o.getTarget("prev");
                    o.canAdvance(i) &&
                    ((Number(new Date()) - h < 550 && Math.abs(e) > 50) ||
                      Math.abs(e) > u / 2)
                      ? o.flexAnimate(i, o.vars.pauseOnAction)
                      : m ||
        ...
        (o.setup = function (e) {
          if (m)
            ...
            "init" === e &&
              ...
              (o.cloneOffset = 0),
              p &&
                ((i = t.makeArray(o.slides).reverse()),
                (o.slides = t(i)),
                o.container.empty().append(o.slides))),
              o.vars.animationLoop &&
                !f &&
  ...
  (function (t, e, n) {
    var i = {
        ...
        for (
          ...
          (r += o.itemWidth),
            ...
            o.options.scrollPerPage === !0 &&
              ...
              i !== a &&
                ((o.pagesInArray[a] = o.positionsInArray[e]), (a = i)));
      },
      ...
      goTo: function (t, n, i) {
        ...
        return a.isTransition
          ...
          : ("function" == typeof a.options.beforeMove &&
            ...
            t >= a.maximumItem ? (t = a.maximumItem) : 0 >= t && (t = 0),
            (a.currentItem = a.owl.currentItem = t),
            a.options.transitionStyle !== !1 &&
            "drag" !== i &&
            1 === a.options.items &&
            a.browser.support3d === !0
              ? (a.swapSpeed(0),
                a.browser.support3d === !0
                  ? a.transition3d(a.positionsInArray[t])
                  : a.css2slide(a.positionsInArray[t], 1),
                a.afterGo(),
                a.singleItemTransition(),
                !1)
              : ((o = a.positionsInArray[t]),
                a.browser.support3d === !0
                  ? ((a.isCss3Finish = !1),
                    n === !0
                      ? (a.swapSpeed("paginationSpeed"),
                        e.setTimeout(function () {
                          a.isCss3Finish = !0;
                        }, a.options.paginationSpeed))
                      : "rewind" === n
                      ? (a.swapSpeed(a.options.rewindSpeed),
                        e.setTimeout(function () {
                          a.isCss3Finish = !0;
                        }, a.options.rewindSpeed))
                      : (a.swapSpeed("slideSpeed"),
                        e.setTimeout(function () {
                          a.isCss3Finish = !0;
                        }, a.options.slideSpeed)),
                    a.transition3d(o))
                  : n === !0
                  ? a.css2slide(o, a.options.paginationSpeed)
                  : "rewind" === n
                  ? a.css2slide(o, a.options.rewindSpeed)
                  : a.css2slide(o, a.options.slideSpeed),
                void a.afterGo()));
      },
      jumpTo: function (t) {
        var e = this;
      ...
      gestures: function () {
        ...
        function o(e) {
          "on" === e
            ? (t(n).on(l.ev_types.move, r), t(n).on(l.ev_types.end, s))
            : "off" === e &&
        ...
        function a(n) {
          ...
          if (!(l.itemsAmount <= l.options.items)) {
            ...
            l.options.autoPlay !== !1 && e.clearInterval(l.autoPlayInterval),
              ...
              (a = t(this).position()),
              (u.relativePos = a.left),
              (u.offsetX = i(r).x - a.left),
              (u.offsetY = i(r).y - a.top),
              o("on"),
              (u.sliding = !1),
        ...
        function r(o) {
          var a,
            r,
            s = o.originalEvent || o || e.event;
          (l.newPosX = i(s).x - u.offsetX),
            (l.newPosY = i(s).y - u.offsetY),
            ...
            (l.newPosX = Math.max(Math.min(l.newPosX, a()), r())),
          ...
          (s.target = s.target || s.srcElement),
            ...
            0 !== l.newRelativeX &&
              ...
              u.targetElement === s.target &&
                ...
                (a = t._data(s.target, "events").click),
                (r = a.pop()),
                a.splice(0, 0, r))),
            o("off");
        }
      ...
      closestItem: function () {
        var e = this,
          ...
          o = null;
        return (
          t.each(n, function (a, r) {
            i - e.itemWidth / 20 > n[a + 1] &&
            i - e.itemWidth / 20 < r &&
            "left" === e.moveDirection()
              ? ((o = r),
                e.options.scrollPerPage === !0
                  ...
                  : (e.currentItem = a))
              : i + e.itemWidth / 20 < r &&
                i + e.itemWidth / 20 > (n[a + 1] || n[a] - e.itemWidth) &&
                "right" === e.moveDirection() &&
                (e.options.scrollPerPage === !0
                  ? ((o = n[a + 1] || n[n.length - 1]),
                    (e.currentItem = t.inArray(o, e.positionsInArray)))
                  : ((o = n[a + 1]), (e.currentItem = a + 1)));
          }),
          e.currentItem
        );
      },
            ...
            "loaded" !== n.data("owl-loaded") &&
              ...
              "string" == typeof o.data("src")
                ? (void 0 === n.data("owl-loaded") &&
                  ...
                  (a = r.options.lazyFollow === !0 ? i >= r.currentItem : !0),
                  a &&
                    i < r.currentItem + r.options.items &&
                    o.length &&
                    r.lazyPreload(n, o))
      ...
      lazyPreload: function (t, n) {
        function i() {
          t.data("owl-loaded", "loaded").removeClass("loading"),
            ...
            "fade" === r.options.lazyEffect ? n.fadeIn(400) : n.show(),
        ...
        var a,
          ...
          s = 0;
        "DIV" === n.prop("tagName")
          ? (n.css("background-image", "url(" + n.data("src") + ")"), (a = !0))
          : (n[0].src = n.data("src")),
          o();
      },
      autoHeight: function () {
        function n() {
          ...
          a.wrapperOuter.css("height", n + "px"),
            a.wrapperOuter.hasClass("autoHeight") ||
              e.setTimeout(function () {
        ...
        function i() {
          (o += 1),
            a.completeImg(r.get(0))
              ? n()
              : 100 >= o
              ? e.setTimeout(i, 100)
              : a.wrapperOuter.css("height", "");
        }
        var o,
          a = this,
      ...
      removeItem: function (t) {
        var e,
          n = this;
        return 0 === n.$elem.children().length
          ? !1
          : ((e = void 0 === t || -1 === t ? -1 : t),
            n.unWrap(),
        ...
        return (
              ...
              (i = e[n]),
                ...
                a.push(
                  function () {
                    var e, a, r, s;
                    for (
                      r = this.vendors, s = [], e = 0, a = r.length;
                      a > e;
                      e++
                    )
                      (o = r[e]),
          ...
          (i.prototype.vendorCSS = function (t, e) {
            ...
            for (
              ...
              (o = s[a]), (n = n || i.getPropertyCSSValue("-" + o + "-" + e));
            return n;
          }),
          ...
          (i.prototype.isVisible = function (t) {
            ...
            return (
              ...
              (o = a + this.element.clientHeight - n),
              (i = this.offsetTop(t)),
              (e = i + t.clientHeight),
              o >= i && e >= a
            );
  ...
  (function (t, e) {
    ...
    function t(t) {
      if (null === h) {
        for (
          var e = t.length, n = 0, i = document.getElementById(a), o = "<ul>";
          e > n;
    ...
    var a = "",
      ...
      C = {
        ...
        callback: function (a) {
          ...
          (w.innerHTML = a.body),
            "undefined" == typeof w.getElementsByClassName && (f = !1);
          var I = [],
            S = [],
            T = [],
            k = [],
          ...
          if (f)
            for (
              var _ = w.getElementsByClassName("timeline-Tweet");
              P < _.length;

            )
              _[P].getElementsByClassName("timeline-Tweet-retweetCredit")
                .length > 0
                ? L.push(!0)
                : L.push(!1),
                (!L[P] || (L[P] && m)) &&
                  (I.push(
                    _[P].getElementsByClassName("timeline-Tweet-text")[0]
                  ),
                  E.push(_[P].getAttribute("data-tweet-id")),
                  S.push(
                    h(_[P].getElementsByClassName("timeline-Tweet-author")[0])
                  ),
                  T.push(_[P].getElementsByClassName("dt-updated")[0]),
                  M.push(
                    _[P].getElementsByClassName("timeline-Tweet-timestamp")[0]
                  ),
                  void 0 !==
                  _[P].getElementsByClassName("timeline-Tweet-media")[0]
                    ? k.push(
                        _[P].getElementsByClassName("timeline-Tweet-media")[0]
                      )
                    : k.push(void 0)),
            ...
            for (var _ = i(w, "timeline-Tweet"); P < _.length; )
              i(_[P], "timeline-Tweet-retweetCredit").length > 0
                ? L.push(!0)
                : L.push(!1),
                (!L[P] || (L[P] && m)) &&
                  (I.push(i(_[P], "timeline-Tweet-text")[0]),
                  E.push(_[P].getAttribute("data-tweet-id")),
                  S.push(h(i(_[P], "timeline-Tweet-author")[0])),
                  T.push(i(_[P], "dt-updated")[0]),
                  M.push(i(_[P], "timeline-Tweet-timestamp")[0]),
                  void 0 !== i(_[P], "timeline-Tweet-media")[0]
                    ? k.push(i(_[P], "timeline-Tweet-media")[0])
                    : k.push(void 0)),
                P++;
          I.length > r &&
            (I.splice(r, I.length - r),
            S.splice(r, S.length - r),
            T.splice(r, T.length - r),
            L.splice(r, L.length - r),
            k.splice(r, k.length - r),
            M.splice(r, M.length - r));
          var A = [],
            P = I.length,
            z = 0;
          if (x)
            ...
            for (; P > z; ) {
              ...
              s
                ? (y && (n(I[z]), d && n(S[z])),
                  d &&
                    ($ += '<div class="user">' + e(S[z].innerHTML) + "</div>"),
                  ($ += '<p class="tweet">' + e(I[z].innerHTML) + "</p>"),
                  c &&
                    ($ += b
                      ...
                      : '<p class="timePosted">' +
                        ...
                        "</p>"))
                : I[z].textContent
                ? (d && ($ += '<p class="user">' + S[z].textContent + "</p>"),
                  ($ += '<p class="tweet">' + I[z].textContent + "</p>"),
                  c &&
                    ($ += '<p class="timePosted">' + T[z].textContent + "</p>"))
                : (d && ($ += '<p class="user">' + S[z].textContent + "</p>"),
                  ($ += '<p class="tweet">' + I[z].textContent + "</p>"),
                  c &&
                    ($ +=
...
twitterFetcher.fetch(config8),
  ...
  (function () {
    ...
    function e() {
      if (document.body) {
        var e = document.body,
          ...
          o = e.scrollHeight;
        if (
          ((C = document.compatMode.indexOf("CSS") >= 0 ? n : e),
          (v = e),
          t(),
          (I = !0),
          top != self)
          ...
          ((n.style.height = "auto"), C.offsetHeight <= i)
        ) {
          var a = document.createElement("div");
      ...
      if (
        ...
        var s = t === document.body,
          l = function (o) {
            ...
            s
              ? window.scrollBy(r, u)
              : (r && (t.scrollLeft += r), u && (t.scrollTop += u)),
              e || n || (k = []),
              k.length ? A(l, t, i / y.frameRate + 1) : (L = !1);
          };
        A(l, t, 0), (L = !0);
      }
    }
    ...
    function i(t) {
      ...
      var a = t.wheelDeltaX || 0,
        r = t.wheelDeltaY || 0;
      return (
        a || r || (r = t.wheelDelta || 0),
        !y.touchpadSupport && p(r)
          ? !0
          : (Math.abs(a) > 1.2 && (a *= y.stepSize / 120),
            Math.abs(r) > 1.2 && (r *= y.stepSize / 120),
            n(o, -a, -r),
    ...
    function o(t) {
      var e = t.target,
        i =
          ...
          t.altKey ||
          t.metaKey ||
          (t.shiftKey && t.keyCode !== T.spacebar);
      if (
    ...
    function s(t) {
      ...
      do {
        ...
        if ((e.push(t), n === t.scrollHeight)) {
          ...
          ((overflow = getComputedStyle(t, "").getPropertyValue("overflow-y")),
    ...
    function h(t) {
      return t >= 1
        ...
        : 0 >= t
        ? 0
        : (1 == y.pulseNormalize && (y.pulseNormalize /= m(1)), m(t));
    }
    var v,
      g = {
        frameRate: 150,
            ...
            r = function (n, o, r, s, u, h, v, g) {
              ...
              if (!n.data("sticky_kit")) {
                ...
                if (
                  ((b = !1),
                  (y = !1),
                  (E = null != c ? c && n.closest(c) : t("<div />")),
                  E && E.css("position", n.css("position")),
                  (T = function () {
                    var t, e, a;
                    if (!g)
                      return (
                        ...
                        b &&
                          ((b = !1),
                          (y = !1),
                          null == c && (n.insertAfter(E), E.detach()),
                          n
                            .css({
                              position: "",
                              top: "",
                    ...
                    (M = function () {
                      ...
                      if (!g)
                        return (
                          ...
                          b &&
                          a &&
                          (null == M && (M = k + h + C > s + r), !y && M)
                            ? ((y = !0),
                              "static" === S.css("position") &&
                                S.css({
                                  position: "relative",
                                }),
                              n
  ...
  (function (t, e, n, i) {
    ...
    var o = {
      ...
      setActiveLink: function (t) {
        ...
        e.hasClass(this.options.currentClass) ||
      ...
      getCurrentSection: function (e) {
        ...
        for (n = 0; n < this.$links.length; n++)
          (i = this.$links[n].hash),
            t(i).length &&
              ((o = this.getCoords(t(i))),
              e >= o.top - this.options.threshold && (a = i));
        ...
        (this.getCanvas = function () {
            ...
            e.scaleColor || e.trackColor
              ? o.getImageData && o.putImageData
                ? n
                  ...
                  : (c(), (n = o.getImageData(0, 0, e.size * a, e.size * a)))
                : (this.clear(), c())
              : this.clear(),
              (o.lineCap = e.lineCap);
            var i;
          ...
          (this.animate = function (t, n) {
            ...
            var o = function () {
              ...
              this.draw(r),
                e.onStep(t, n, r),
                a >= e.animate.duration ? e.onStop(t, n) : u(o);
            }.bind(this);
            u(o);
          }.bind(this));
      },
      n = function (t, n) {
        ...
        var o = {},
          ...
          r = function () {
            ...
            for (var e in i)
              i.hasOwnProperty(e) &&
                ((o[e] = n && "undefined" != typeof n[e] ? n[e] : i[e]),
  ...
  (function (t) {
    ...
    function e() {
      (o = t.innerWidth || document.documentElement.clientWidth),
    ...
    function i(n) {
      t.requestAnimationFrame(function () {
        "scroll" !== n.type && e();
        for (var t = 0, i = m.length; i > t; t++)
          "scroll" !== n.type && (m[t].coverImage(), m[t].clipContainer()),
            m[t].onScroll();
      });
    }
    Date.now ||
    ...
    var o,
      ...
      r = (function () {
        ...
        for (var o in i)
          "undefined" != typeof n.style[o] &&
            ((n.style[o] = "translate3d(1px,1px,1px)"),
    ...
    (h.prototype.css = function (e, n) {
      ...
      (h.prototype.init = function () {
        ...
        (e.image.$container = document.createElement("div")),
          ...
          e.image.useImgTag && r && e.options.enableTransform
          ...
          f && (i.backgroundAttachment = "fixed"),
          (e.parentWithTransform = 0);
        for (
          var o = e.$item;
          null !== o && o !== document && 0 === e.parentWithTransform;

        )
          (e.css(o, "-webkit-transform") ||
            e.css(o, "-moz-transform") ||
            e.css(o, "transform")) &&
      ...
      (h.prototype.clipContainer = function () {
        if (!f) {
          ...
          t.$clipStyles.styleSheet
            ? (t.$clipStyles.styleSheet.cssText = a)
            : (t.$clipStyles.innerHTML = a);
        }
      }),
      (h.prototype.coverImage = function () {
        ...
        if (t.image.width && t.image.height) {
          ...
          c &&
            ((d = (u * (i + a)) / 2),
            (0 > u || u > 1) && (d = (u * Math.max(i, a)) / 2),
            0 > u || u > 1
              ? (f = Math.max(i, a) + 2 * Math.abs(d))
              : (f += Math.abs(a - i) * (1 - u))),
            (p = (f * s) / l),
            n > p && ((p = n), (f = (p * l) / s)),
            ...
            !(c && a > f) ||
              ...
              ((t.bgPosVerticalCenter = (a - f) / 2), (f = a)),
            c
              ? ((m = o + (n - p) / 2), (h = (a - f) / 2))
              : ((m = (n - p) / 2), (h = (i - f) / 2)),
            t.parentWithTransform && (m -= o),
      ...
      (h.prototype.onScroll = function (t) {
        ...
        if (e.image.width && e.image.height) {
          ...
          e.isElementInViewport =
            n.bottom >= 0 && n.right >= 0 && a >= i && n.left <= o;
      ...
      for (a; o > a; a++)
        if (
          ("object" == typeof n || "undefined" == typeof n
            ? t[a].jarallax || (t[a].jarallax = new h(t[a], n))
  ...
  (function (t) {
    ...
    (i.prototype.parseURL = function (t) {
      ...
      (i.prototype.getImageURL = function (t) {
        ...
        if (
          ("youtube" === e.type &&
            ((e.videoImage =
              "https://img.youtube.com/vi/" + e.videoID + "/maxresdefault.jpg"),
            t(e.videoImage)),
          "vimeo" === e.type)
        ) {
    ...
    i.prototype.loadAPI = function () {
      ...
      if (!o || !a) {
        ...
        "youtube" !== e.type ||
          o ||
          ((o = 1), (n = "//www.youtube.com/iframe_api")),
          "vimeo" !== e.type ||
            a ||
            ((a = 1), (n = "//f.vimeocdn.com/js/froogaloop2.min.js")),
    ...
    (i.prototype.onAPIready = function (e) {
      ...
      if (
        ("youtube" === n.type &&
          (("undefined" != typeof YT && 0 !== YT.loaded) || r
      ...
      (e =
        ...
        t(window).on("resize", function () {
          var i = Math.max(t(window).width(), window.innerWidth),
            o = t(".has-submenu");
          i > n && o.removeClass("submenu-open"),
            i > n && e !== !0
              ? (o.children("a").unbind("click"),
        ...
        .jqBootstrapValidation({
          ...
          submitSuccess: function (e, n) {
            ...
            t.ajax({
              ...
              success: function (t) {
                1 == t.sendstatus
                  ? (o.html(t.message), e.fadeOut(500))
                  : o.html(t.message);
              },
            });
          },
